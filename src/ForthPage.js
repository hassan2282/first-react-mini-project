          ...
          <div className='flex flex-col justify-center items-center w-[60%] h-[50%] rounded-md space-y-10 backdrop-blur-xl'>
            <Fade left>
              ...
              <div className='flex flex-row w-[38%] h-auto gap-2 justify-center' dir='rtl'>
                <Fade right>
                  <button className='basis-1/4 p-3 shadow-md shadow-black active:shadow-none text-white rounded-md border-2 border-white hover:bg-white hover:text-indigo-950 duration-150'>ارسال</button>
                  <input type='email' className='basis-3/4 rounded-md p-2 border-2 border-white  text-white' placeholder='ایمیل خود را وارد کنید ...' />
                </Fade>
              </div>
              <Fade bottom cascade>
                <ul className='flex flex-row w-[80%] *:text-white space-x-3 justify-center items-center hover:*:text-indigo-950 *:duration-300 *:cursor-pointer *:rounded-md *:border-2 *:border-white *:p-2 *:px-12 hover:*:bg-white'>
